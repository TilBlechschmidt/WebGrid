...
use domain::request::{ProvisionerMatchRequest, ProvisionerMatchResponse};
use harness::Service;
use library::communication::request::{OptionalRequestProcessor, Request, Responder};
...
mod does {
    use super::*;
    use domain::webdriver::{Capabilities, CapabilitiesRequest};
