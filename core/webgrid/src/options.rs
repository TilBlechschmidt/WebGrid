...
#[derive(Debug, StructOpt)]
pub enum Command {
    Node(modules::node::Options),
    Manager(modules::manager::Options),
    Orchestrator(modules::orchestrator::Options),
    Gangway(modules::gangway::Options),
    Collector(modules::collector::Options),
    Api(modules::api::Options),
}
