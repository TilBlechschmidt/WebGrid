use crate::communication::event::QueueDescriptor;
use crate::communication::request::{Request, RequestError, Requestor, ResponseCollectionTimeout};
...
mod does {
    ...
    use crate::communication::request::ResponseLocation;
    use pretty_assertions::assert_eq;
